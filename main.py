...
from scapy.all import (Dot11, Dot11Beacon,Dot11Elt,Dot11ProbeReq,Dot11ProbeResp,sniff,RadioTap,Dot11Deauth,sendp)
import logging
...
def attack():
    ...
    print("In order to change back card into regular wifi-mode run the following command after you are done: \n"
